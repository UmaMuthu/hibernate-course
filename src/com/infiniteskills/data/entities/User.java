...
public class User {
	...
	public String toString() {
		return "User [userId=" + userId + ", firstName=" + firstName + ", lastName=" + lastName + ", birthDate="
				...
				+ ", age=" + age + ", getAge()=" + getAge() + ", getUserId()=" + getUserId() + ", getFirstName()="
				+ getFirstName() + ", getLastName()=" + getLastName() + ", getBirthDate()=" + getBirthDate()
				+ ", getEmailAddress()=" + getEmailAddress() + ", getLastUpdatedDate()=" + getLastUpdatedDate()
				+ ", getLastUpdatedBy()=" + getLastUpdatedBy() + ", getCreatedDate()=" + getCreatedDate()
